...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\imohi\\Desktop\\GitHub Repo\\loan-savings-management-system\\apps\\backend\\src\\infrastructure\\database\\generated\\prisma",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
    ...
    previewFeatures: [],
    sourceFilePath:
      "C:\\Users\\imohi\\Desktop\\GitHub Repo\\loan-savings-management-system\\apps\\backend\\src\\infrastructure\\database\\schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineSchemaHash:
    "b090c356a2cfbe1cf5d7414c8b2f209bf3c30f4d575e83a59f1ed5a1e53fb865",
  copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = [
    ...
    "infrastructure/database/generated/prisma",
  ];
...
path.join(
  process.cwd(),
  "src/infrastructure/database/generated/prisma/query_engine-windows.dll.node",
);
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(
  process.cwd(),
  "src/infrastructure/database/generated/prisma/schema.prisma",
);
