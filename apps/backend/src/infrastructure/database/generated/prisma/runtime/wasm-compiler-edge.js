...
function No(e, t) {
  var r,
    ...
    R = e.constructor,
    C = R.precision;
  if (!e.s || !t.s) return t.s ? (t.s = -t.s) : (t = new R(e)), G ? $(t, C) : t;
  if (
    ((f = e.d),
    (A = t.d),
    (n = t.e),
...
var ct,
  ...
  Uo = fe(() => {
    ...
    S.times = S.mul = function (e) {
      ...
      for (; !o[--s]; ) o.pop();
      return (
        t ? ++r : o.shift(), (e.d = o), (e.e = r), G ? $(e, A.precision) : e
      );
    };
      ...
      return function (n, i, o, s) {
        ...
        if (((ue = (ue / j + 2) | 0), (T = 0), Ee == 1))
          for (v = 0, K = K[0], ue++; (T < Je || v) && ue--; T++)
            (V = v * ee + (Te[T] || 0)), (D[T] = (V / K) | 0), (v = V % K | 0);
        else {
          for (
            v = (ee / (K[0] + 1)) | 0,
              v > 1 &&
            ...
            I[M++] = 0;
          (Br = K.slice()), Br.unshift(0), (Yn = K[0]), K[1] >= ee / 2 && ++Yn;
          do
            (v = 0),
              (d = t(K, I, Ee, M)),
              d < 0
...
var At = class {
  ...
  json(t) {
    return (
      Ks(this._client), this._client._engine.metrics({ format: "json", ...t })
    );
  }
};
l();
  ...
  return await r.runInChildSpan(
    ...
    async () => {
      let o = new Date(),
        ...
        f = w.now();
      return (
        n?.({ timestamp: o, duration: f - s, query: e.sql, params: e.args }), d
      );
    },
  );
}
  ...
  class t {
    ...
    async _transactionWithCallback({ callback: n, options: i }) {
      ...
      try {
        ...
        throw (
          (await this._engine.transaction("rollback", o, d).catch(() => {}), T)
        );
      }
      return f;
    }
