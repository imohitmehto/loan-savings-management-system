...
// Root layout with font setup + page offset
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${geistSans.variable} ${geistMono.variable} ${poppins.variable} ${satisfy.variable} font-sans antialiased bg-slate-950 text-white`}
      >
        {/* <ClientLayout> */}
