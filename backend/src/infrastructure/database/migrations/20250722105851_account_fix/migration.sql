/*
  ...
  - Added the required column `fatherSpouse` to the `Account` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "fatherSpouse" TEXT NOT NULL,
