...
import { isValidForm } from "@/validators/emiSchema";
 ...
 * Handles form input, validation, API calculation, and result display.
 */
export const EmiCalculator: React.FC = () => {
  ...
  // Controlled field change handler
  const handleChange = (
    ...
    setForm((prev) => ({
      ...prev,
      [name]:
        // Ensure number fields are converted
        ["amount", "interestRate", "term", "latePaymentPenalty"].includes(name)
          ? Number(value)
          : value,
    }));
  };
  ...
  return (
    <div className="max-w-xl p-6 mx-auto mt-8 border rounded shadow bg-white">
